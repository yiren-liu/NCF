...
#import sys
#sys.path.append('F:\\PycharmProjects\\NeuralCF_tensorflow\\NeuralCF_tensorflow')
#sys.path.append('F:\\PycharmProjects\\NeuralCF_tensorflow\\NeuralCF_tensorflow\\Data\\ml-1m')
...
from models.CCF import *



def single_run(args, dataset):
    
    model = CCF(args, dataset.num_users, dataset.num_items)
    model.build_model()
...
if __name__ == '__main__':
    ...
    dataset = ImpDataset.ImpDataset(args.data_dir)
